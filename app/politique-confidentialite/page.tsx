          ...
          <div className="bg-blue-50 p-6 rounded-lg mb-8">
            <p className="text-justify">
              <strong>
                ...
                clients, prospects et visiteurs de son site web, conformément au Règlement Général sur la Protection des
          ...
          <section className="mb-8">
            ...
            <div className="text-justify">
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                ...
                <li>
                  <strong>Partenaires :</strong> sous-traitants techniques (avec accord contractuel de confidentialité)
                </li>
                <li>
          ...
          <section className="mb-8">
            ...
            <div className="text-justify">
              <p>
                ...
                Toute modification sera portée à votre connaissance par publication sur cette page avec indication de la
                date de mise à jour.
              </p>
            </div>
          </section>
