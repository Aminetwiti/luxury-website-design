        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Découvrez nos 19 projets d'exception à travers Paris, PACA et les Antilles. Chaque réalisation témoigne de
              notre expertise technique et de notre vision architecturale.
            </p>
