        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-blue-50 p-6 rounded-lg mb-8">
            <p className="text-justify">
              <strong>
                ...
                réalisées par B.E StructiBA. Elles définissent les droits et obligations des parties dans le cadre de la
                vente de prestations intellectuelles d'études techniques.
              </strong>
            </p>
          </div>
          ...
          <section className="mb-8">
            ...
            <div className="text-justify">
              ...
              <p className="mt-4">
                <strong>2.3 Modifications :</strong> Toute modification du cahier des charges initial fera l'objet d'un
                avenant au contrat.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="mt-4 text-justify">
                <strong>3.4 Retard de paiement :</strong> En cas de retard, des pénalités de 3 fois le taux légal seront
          ...
          <section className="mb-8">
            ...
            <div className="text-justify">
              <p>
                <strong>4.1 Délais indicatifs :</strong> Les délais d'exécution sont donnés à titre indicatif et courent
                à compter de la réception de l'acompte et de tous les éléments nécessaires à l'étude.
              </p>
              <p className="mt-4">
          ...
          <section className="mb-8">
            ...
            <div className="text-justify">
              <p>
                <strong>6.1 Modalités :</strong> Les documents d'étude sont remis au client par voie électronique (PDF)
                et/ou sur support papier selon les modalités convenues.
              </p>
              <p className="mt-4">
                <strong>6.2 Vérification :</strong> Le client dispose de 15 jours pour formuler ses observations. Passé
                ce délai, les documents sont réputés acceptés.
              </p>
              <p className="mt-4">
          ...
          <section className="mb-8">
            ...
            <div className="text-justify">
              ...
              <p className="mt-4">
                <strong>8.3 Reproduction :</strong> La reproduction des documents à des fins commerciales est interdite
          ...
          <section className="mb-8">
            ...
            <div className="text-justify">
              ...
              <p className="mt-4">
                ...
                (non-paiement, non-fourniture des éléments nécessaires), B.E StructiBA peut résilier le contrat de plein
                droit après mise en demeure restée sans effet pendant 15 jours.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="text-justify">
              ...
              <p className="mt-4">
                La partie concernée devra informer l'autre partie dans les meilleurs délais de la survenance d'un cas de
                force majeure.
              </p>
            </div>
          </section>
