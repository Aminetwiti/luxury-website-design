    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-16 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="absolute inset-0 opacity-10">
          <Image
            src="/images/Legal_Documentation_Engineering.jpg"
            alt="Documentation légale ingénierie"
            fill
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300">
              Informations légales et réglementaires du bureau d'études B.E StructiBA
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="text-justify">
                <p>
                  B.E StructiBA est un bureau d'études spécialisé en ingénierie structurelle et béton armé. Nos
            ...
            <section className="mb-8">
              ...
              <div className="text-justify">
                ...
                <p className="mt-4">
                  ...
                  écrite préalable de B.E StructiBA.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="text-justify">
                <p>
                  B.E StructiBA s'efforce d'assurer au mieux l'exactitude et la mise à jour des informations diffusées
                  sur ce site. Toutefois, B.E StructiBA ne peut garantir l'exactitude, la précision ou l'exhaustivité
